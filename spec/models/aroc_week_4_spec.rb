...
# ----------------------
  ...
  it '23. returns all orders which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    #  Solution goes here
    orders = Order.joins(:order_items).where(order_items: {item_id: @item_4.id}).distinct
    # -----------------------------------------------------------
  ...
  it '24. returns all orders for user 2 which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    #  Solution goes here
    orders = Order.where(user: @user_2).joins(:order_items).where(order_items: {item: @item_4})
    # -----------------------------------------------------------
